...
export default function Cadastro() {
  ...
  return (
    <div className="mx-auto max-w-lg w-full px-6 py-16 flex-1">
      <h1 className="text-2xl font-bold mb-1">Cadastrar empresa</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <label className="flex flex-col gap-1 text-sm">
          <span className="text-neutral-600">Senha (mínimo 8 caracteres)</span>
          <input
            type="password"
            required
            minLength={8}
        ...
        <label className="flex flex-col gap-1 text-sm">
          <span className="text-neutral-600">Razão social</span>
          <input
            required
            className="input"
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <label className="flex flex-col gap-1 text-sm">
            <span className="text-neutral-600">RNTRC</span>
            <input
              required
              className="input"
              value={form.rntrc}
        ...
        <label className="flex flex-col gap-1 text-sm">
          <span className="text-neutral-600">Tipo de transportador</span>
          <select
            className="input"
